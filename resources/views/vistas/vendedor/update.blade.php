        ...
        <div class="row mt-4">
            <div class="col-md-6">
                ...
                <div class="input-group mt-2">
                    ...
                    <input required type="text" class="form-control" name="nombre" id="nombre" value="{{ $vendedor->nombre }}">
                </div>
                <div class="input-group mt-2">
                    <span class="input-group-text">Apellido</span>
                    <input required type="text" class="form-control" name="apellido" id="apellido" value="{{ $vendedor->apellido }}">
                </div>
                <div class="input-group mt-2">
                    <span class="input-group-text">RUT</span>
                    <input required type="text" class="form-control" name="rut" id="rut" value="{{ $vendedor->rut }}">
                </div>
                <div class="input-group mt-2">
                    <span class="input-group-text">Email</span>
                    <input required type="text" class="form-control" name="email" id="email" value="{{ $vendedor->email }}">
                </div>
                <div class="input-group mt-2">
                    <span class="input-group-text">Direccion</span>
                    <input required type="text" class="form-control" name="direccion" id="direccion" value="{{ $vendedor->direccion }}">
                </div>
                <div class="input-group mt-2">
                    <span class="input-group-text">Telefono</span>
                    <input required type="text" class="form-control" name="telefono" id="telefono" value="{{ $vendedor->telefono }}">
                </div>
                <div class="input-group mt-2">
